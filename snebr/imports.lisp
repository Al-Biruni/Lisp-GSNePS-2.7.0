...
;; Version: $Id: imports.lisp,v 1.3 2007/08/21 01:54:23 mwk3 Exp $
...
(import '(sneps:is.n sneps:describe.n sneps:nodeset.n sneps:node-to-number.n
	  sneps:new.ns sneps:isnew.ns sneps:ismemb.ns sneps:nodeaccess sneps:node sneps:node-asupport sneps:node-grade
	  sneps:node-assert sneps:context-grade sneps:node-contexts-grades sneps:context-order
...
(import '(sneps:is.ct sneps:new.cts sneps:isnew.cts sneps:ismemb.cts
	  ...
	  sneps:ctcs-to-cts sneps:update-contexts sneps:repeat sneps:buildcontext
          sneps:fullbuildcontext
	  sneps:value.sv sneps:name.ct sneps:isassert.n sneps:context-hyps snip:remark))
