...
;; Version: $Id: exports.lisp,v 1.3 2007/08/21 01:54:23 mwk3 Exp $
...
(export '(new.ns isnew.ns is.ns ismemb.ns choose.ns others.ns makeone.ns make.ns union.ns do.ns
...
(export '(pathfrom checkpath evalsnd protect-eval pseudolisp initialized-p
	  node-fcableset node-type node-freevars node-gsupport node-perm node-p node-na node-snepslog
...
(export '(new.cts isnew.cts ismemb.cts choose.cts last.cts others.cts makeone.cts union.cts
	  insert.cts cardinality.cts remove.cts issubset.cts repeat name.ct
	  value.sv isassert.n context-hyps context-gprops context-grade context-order context-telprops context-restriction 
	  fullbuildcontext compl.ns
	  node-asupport node-grade node-contexts-gprops node-contexts-grades node-assert node-ants node n^ c^ default-defaultct all-hyps
	  new.c relation.c nodeset.c
	  hyp der ext tel assertion restriction named snip crntct
	  ...
	  getcontextset.ctcs get-tel-contextset.ctcs filter.ctcs ctcs-to-cts ctcs-to-ots
