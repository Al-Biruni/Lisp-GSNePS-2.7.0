...
;; Version: $Id: dbms.lisp,v 1.3 2007/08/21 01:54:28 mwk3 Exp $
...
numbers."
  (makeone.ns (apply-function-to-ns #'lisp:min ns)))
...
numbers."
  (makeone.ns (apply-function-to-ns #'lisp:max ns)))
...
numbers."
  (makeone.ns (apply-function-to-ns #'lisp:+ ns)))
