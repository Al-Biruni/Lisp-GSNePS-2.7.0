...
;; Version: $Id: ctcableset.lisp,v 1.3 2007/08/21 01:54:25 mwk3 Exp $
...
(defun get-tel-contextset.ctcs (ctcs)
  (cond ((null ctcs) nil)
  ((numberp (first ctcs)) (second ctcs))
  (t (get-tel-contextset.ctcs (rest (rest ctcs))))))
