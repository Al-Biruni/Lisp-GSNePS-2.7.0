...
;; Version: $Id: nodeset.lisp,v 1.3 2007/08/21 01:54:26 mwk3 Exp $
...
;       returns       : <boolean>
;
;       description   : returns true if all nodes in ns have a true node-assert
;                       
;
;                       
;                                        written :  nea 7/15
(defun all-asserted.ns (ns)
 (cond ((isnew.ns ns) t)
  ( (not(eq (node-assert (first ns)) t)) nil)
  (t (all-asserted.ns (others.ns ns))))
)
