...
;; Version: $Id: node0.lisp,v 1.3 2007/08/21 01:54:26 mwk3 Exp $
...
(defstruct (node
  ...
  (grade nil)      ; Node grade. A real number denoting the node's grade
                   ; to be used by SneBR for contradictions elimination ; added nea 7/15
  ...
  (contexts-gprops (make-hash-table));; Hash table to store the gprops belonging to the contexts where the node exists
  (contexts-grades (make-hash-table));; Hash table to store the fused contexts grades
