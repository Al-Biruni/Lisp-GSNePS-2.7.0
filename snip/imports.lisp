...
;; Version: $Id: imports.lisp,v 1.3 2007/08/21 01:54:34 mwk3 Exp $
...
(import '(sneps:is.n sneps:isbase.n sneps:isvar.n sneps:ismol.n sneps:ispat.n sneps:describe.n
	  ...
	  sneps:remove.ns sneps:cardinality.ns sneps:context-gprops sneps:context-grade sneps:node-grade sneps:context-order
	  sneps:node-contexts-gprops   sneps: node-contexts-grades
	  sneps:context-telprops
	  sneps:apply-subst.cs sneps:clean-quantifiers.cs sneps:issubset.cs
;	  sneps:match.cs
	  sneps:crntct))

(import '(sneps:fullbuildcontext sneps:issubset.ct sneps:cts sneps:last.cts
...
(import '(sneps:hyp sneps:der sneps:tel))
