...
;; $Id: jl-config.cl,v 1.1 2007/08/17 03:41:07 mwk3 Exp $
...
(setf javatools.jlinker:*jlinker-java-home* "/usr/lib/jvm/java-7-openjdk-amd64")
(setf javatools.jlinker:*jni-library* "/usr/lib/jvm/java-7-openjdk-amd64/jre/bin")
...
;;;???(Case B only)  Insert your own machine names here.
	...
	(:bb1        "/usr/java130")  
	(:right      "/opt/java1.2") 
        (:nickelback       "/usr/java/jdk1.6.0/bin")
